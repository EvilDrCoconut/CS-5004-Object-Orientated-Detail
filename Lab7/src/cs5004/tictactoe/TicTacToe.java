...
public interface TicTacToe {
  ...
  /**
   * Return whether the game is over. The game is over when either the board is full,
   *     or one player has won.
   * @return true if the game is over, false otherwise
   */
  boolean isGameOver();

  /** Return the winner of the game, or {@code null} if there is no winner. If the game
   *     is not over, returns {@code null}.
  ...
  /** Return the current {@link Player} mark at a given row and column, or {@code null}
